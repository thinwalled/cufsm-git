function [] = vdisppic(node, elem, axesnum, scale, mode, m_a, BC, SurfPos)
    ...
    % Date:     1998
    % Modifications:
    %   2003 - Benjamin W. Schafer - Modified to plot longitudinal displacements.
    %   July 2010 - Zhanjie Li - Modified to plot longitudinal displacements for general BCs.
    ...
    if maxdisp == 0
        maxdisp = 1;
    end % vdisppic() can be called when displacements are all zero
