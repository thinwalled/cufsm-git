function [] = dispshp2_fine(undef, L, node, elem, mode, axesnum, scalem, m_a, BC, ifpatch)
    % Author:   Benjamin W. Schafer
    % Date:     1998
    % Modifications:
    %   2010 - Benjamin W. Schafer and Zhanjie Li - Improvements for speed and generality.
