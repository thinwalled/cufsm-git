function [] = dispshap(undef, node, elem, mode, axesnum, scalem, springs, m_a, BC, SurfPos)
    ...
    % Date:     August 2000
    % Modifications:
    %   April 2004 - Benjamin W. Schafer - changed to patch to allow solid plots.
    %   2010 - Zhanjie Li - modified to general boundary conditions.
    %   2015 - Benjamin W. Schafer - Fixing springs plotting (back in 2017 for more spring plotting).
    ...
    for i = 1:length(elem(:, 1))
        ...
        % dbar is the nodal displacements for the element in global coordinates.
        % dbar = (u1 v1 u2 v2 w1 o1 w2 o2)';
        dbar = zeros(8, 1);
        dbarm = zeros(8, 1);
        dlbarm = zeros(3, 9);
        ...
        for mn = 1:totalm
            ...
            links = 10; % Number of additional line segments to define the displaced shape
