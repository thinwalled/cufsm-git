function [curve,shapes]=stripmain_vec(prop,node,elem,lengths,springs,constraints,GBTcon,BC,m_all,neigs)
%HISTORY
...
%Jan 2024, calculating is vectorized. Sheng Jin
% 
%INPUTS
...
ifVec = true; %Vectorizing the computation by default
