...
len_txt=uicontrol(fig,...
    'Style','text','units','normalized',...
    'Position',[0.001 0.80 0.059 0.04],...
    'FontName','Arial','FontSize',10,...
    'HorizontalAlignment','Center',...
    'String','length =');
len_cur=uicontrol(fig,...
    'Style','edit','units','normalized',...
    'Position',[0.1 0.81 0.08 0.04],...
    'FontName','Arial','FontSize',10,...
    'HorizontalAlignment','Center',...
...
mode_txt=uicontrol(fig,...
    'Style','text','units','normalized',...
    'Position',[0.001 0.75 0.059 0.04],...
    'FontName','Arial','FontSize',10,...
    'String','mode =');
mode_cur=uicontrol(fig,...
    'Style','edit','units','normalized',...
    'Position',[0.10 0.76 0.08 0.04],...
    'FontName','Arial','FontSize',10,...
...
toggle_3D=uicontrol(fig,...
    'Style','checkbox','units','normalized',...
    'Position',[0.001 0.677 0.029 0.020],...
    'FontName','Arial','FontSize',10,...
    'String','3D',...
    'Value',0,...
    'CallBack',[...
...
title_3dItem=uicontrol(fig,...
    'Style','text','units','normalized',...
    'Position',[0.031 0.675 0.030 0.023],...
    'HorizontalAlignment','right',...
    'String','Item:');
popup_3dItem=uicontrol(fig,...
    'Style','popup','units','normalized',...
    'Position',[0.062 0.675 0.105 0.025],...
...
title_3dStyle=uicontrol(fig,...
    'Style','text','units','normalized',...
    'Position',[0.169 0.675 0.030 0.023],...
    'HorizontalAlignment','right',...
    'String','Style:');
popup_3dStyle=uicontrol(fig,...
    'Style','popup','units','normalized',...
    'Position',[0.20 0.675 0.060 0.025],...
    'String','Surface|Mesh',...
    'Callback',[...
    'compareout_cb(41);']);
%------------------------------------------
title_3dData=uicontrol(fig,...
    'Style','text','units','normalized',...
    'Position',[0.001 0.635 0.030 0.023],...
    'HorizontalAlignment','Left',...
    'String','Data:');
popup_3dData=uicontrol(fig,...
    'Style','popup','units','normalized',...
    'Position',[0.032 0.635 0.135 0.025],...
...
plot_mode2=uicontrol(fig,...
    'Style','push','units','normalized',...
    'Position',[0.169 0.635 0.091 0.025],...
