...
btn_plotmodehelp=uicontrol(fig,...
    ...
    'String','?',...
    'Callback',[...
    'web(''interface/cufsmhelp.html#9'');']);
...
btn_wvlmodehelp=uicontrol(fig,...
    ...
    'String','?',...
    'Callback',[...
    'web(''interface/cufsmhelp.html#10'');']);
%------------------------------------------
...
btn_modehelp=uicontrol(fig,...
    ...
    'String','?',...
    'Callback',[...
    'web(''interface/cufsmhelp.html#11'');']);
%------------------------------------------
...
btn_filehelp=uicontrol(fig,...
    ...
    'String','?',...
    'Callback',[...
    'web(''interface/cufsmhelp.html#17'');']);
...
btn_cfsmhelp=uicontrol(fig,...
    ...
    'String','?',...
    'Callback',[...
    'web(''interface/cufsmhelp.html#22'');']);
