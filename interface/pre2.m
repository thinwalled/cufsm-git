...
doubler=uicontrol(fig,...
	'Style','push','units','normalized',...
	'Position',[0.275-0.1 0.39-0.12 0.09 0.04],...
	'String','Double Elem.',...
...
double_one=uicontrol(fig,...
	'Style','push','units','normalized',...
	'Position',[0.275-0.1 0.35-0.12 0.09 0.04],...
	'String','Divide Elem.',...
...
combine_one=uicontrol(fig,...
	'Style','push','units','normalized',...
	'Position',[0.275-0.1 0.31-0.12 0.09 0.04],...
	'String','Delete Elem.',...
...
translate_some=uicontrol(fig,...
	'Style','push','units','normalized',...
	'Position',[0.275-0.1 0.27-0.12 0.09 0.04],...
	'String','Trans. Node',...
...
move_rot_model_some=uicontrol(fig,...
	'Style','push','units','normalized',...
	'Position',[0.275-0.1 0.23-0.12 0.09 0.04],...
...
dup_section=uicontrol(fig,...
	'Style','push','units','normalized',...
	'Position',[0.275-0.1 0.19-0.12 0.09 0.04],...
	'String','Duplicate',...
    'Tooltip','Duplicate model, i.e. for built-up section',...
	'Callback',[...
		'pre2_cb(105);']);
fillet=uicontrol(fig,...
	'Style','push','units','normalized',...
	'Position',[0.275-0.1 0.15-0.12 0.09 0.04],...
	'String','Add Corner',...
    'Tooltip','Add fillet to a sharp corner',...
	'Callback',[...
		'pre2_cb(106);']);
%
%
...
txt_node=uicontrol(fig,...
    ...
    'FontName','Arial','FontSize',10,...
	'HorizontalAlignment','Left',...
	'String','node# | x | z | x₍dof₎ | z₍dof₎ | y₍dof₎ | θ₍dof₎ | σ');
...
txt_elem=uicontrol(fig,...
    ...
    'FontName','Arial','FontSize',10,...
	'HorizontalAlignment','Left',...
	'String','elem# | node i | node j | t | mat#');
...
master_slave=uicontrol(fig,...
    ...
    'Tooltip','Make a node exactly follow another leader node',...
	'Callback',[...
		'pre2_cb(201);']);
%------------------------------------------------------------------
