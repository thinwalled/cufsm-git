...
%template
subfig=figure;
name=['CUFSM v',version,' -- AISC Shapes'];
...
axestemp=axes('Units','normalized','Position',[0.42 0.1 0.54 0.78],'visible','off');
%
%
...
%     'String','Complex Sections List:');
%SFIA sections dropdownbox



aisc_title=uicontrol(subfig,...
	'Style','text','units','normalized',...
   'Position',[0 0.915 0.15 0.04],...
   'HorizontalAlignment','Right',...
    'String','Section Type:');
[aisc_section_type] = {'W'; 'M'; 'S'; 'HP'; 'C'; 'MC'; 'L'; 'WT'; 'MT'; 'ST'; 'HSS'; 'PIPE'};
aisc=uicontrol(subfig,...
	'Style','popupmenu','units','normalized',...
   'Position',[0.16 0.88 0.24 0.08],...
   'HorizontalAlignment','Right',...
    'String',aisc_section_type,...
   'CallBack',{@update_sfia, subfig});

sfia_title=uicontrol(subfig,...
	'Style','text','units','normalized',...
   'Position',[0 0.764 0.15 0.04],...
   'HorizontalAlignment','Right',...
    'String','Section Label:');
[labels,data] = complexdata();
sfia=uicontrol(subfig,...
	'Style','listbox','units','normalized',...
   'Position',[0.16 0.1 0.24 0.7],...
   'HorizontalAlignment','Right',...
    'String',labels,...
    'Value', 1, ... 
    'Tag', 'sfia_listbox', ...
   'CallBack',[...
		'complex_sections_cb(13);']);
%C/Z toggle
...
%    'Value',1,...
%    'CallBack',[...
% 		'complex_sections_cb(11);']);
% %units toggle
units_title=uicontrol(subfig,...
	'Style','text','units','normalized',...
   'Position',[0 0.889-0.05 0.15 0.04],...
   'HorizontalAlignment','Right',...
	'String','Material Units:');
kipin=uicontrol(subfig,...
   'Style','radio','units','normalized',...
   'Position',[0.16 0.89-0.05 0.1 0.04],...
   'String','kip&in.',...
   'Value',1,...
   'CallBack',[...
...
Nmm=uicontrol(subfig,...
   'Style','radio','units','normalized',...
   'Position',[0.26 0.89-0.05 0.1 0.04],...
   'String','N&mm',...
   'Value',0,...
   'CallBack',[...
...
leaveandsubmit=uicontrol(subfig,...
	...
	'Position',[0.03 0.01 0.15 0.06],...
	'String','Submit to Input',...
    'BackgroundColor','g',...
	'Callback',[...
		'complex_sections_cb(4);']);
btn_genhelp=uicontrol(subfig,...
    'Style','push','units','normalized',...
    'Position',[0.416 0.902 0.04 0.06],...
    'String','?',...
    'Callback',[...
    'cufsmhelp(23);']);
...
% 	'Callback',[...
% 		'complex_sections_cb(12);']);
closetemplate=uicontrol(subfig,...
	'Style','push','units','normalized',...
	'Position',[0.20 0.01 0.18 0.06],...
	'String','Close (don''t submit)',...
    'BackgroundColor','r',...   
   'Callback',[...
		'complex_sections_cb(7);']);
end
%
%
%
...
% 	'Style','text','units','normalized',...
%    'Position',[0.4 0.06 0.6 0.05],...
% 	'String','Note: for complex sections, double check constrains and connecting elements after doubling elements.');
