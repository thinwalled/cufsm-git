...
%bws principal axis bending tweaks 2024
%
%
%general
...
M11title=uicontrol(subfig,...
    'Style','text','units','normalized',...
    'HorizontalAlignment','Right',...
    'Position',[0.01 0.84 0.05 0.03],...
    'String','M11 = ');
M11edit=uicontrol(subfig,...
    'Style','edit','units','normalized',...
    'Position',[0.06 0.84 0.06 0.03],...
    'String',num2str(M11),...
    'Callback',[...
    'loading_cb(1);']);
...
Mxxtitle=uicontrol(subfig,...
    'Style','text','units','normalized',...
    'HorizontalAlignment','Right',...
    'Position',[0.126 0.84 0.05 0.03],...
    'String','Mxx = ');
Mxxedit=uicontrol(subfig,...
    'Style','edit','units','normalized',...
    'Position',[0.185 0.84 0.06 0.03],...
    'String',num2str(Mxx),...
    'Callback',[...
    'loading_cb(1);']);
Mzztitle=uicontrol(subfig,...
    'Style','text','units','normalized',...
    'HorizontalAlignment','Right',...
    'Position',[0.126 0.80 0.05 0.03],...
    'String','Mzz = ');
Mzzedit=uicontrol(subfig,...
    'Style','edit','units','normalized',...
    'Position',[0.185 0.80 0.06 0.03],...
    'String',num2str(Mzz),...
    'Callback',[...
    'loading_cb(1);']);
restrained=uicontrol(subfig,...
   'Style','checkbox','units','normalized',...
   'Position',[0.01 0.76 0.15 0.03],...
   'String','restrained bending about x-z',...
   'Value',0,...
   'CallBack',[...
   'loading_cb(4);']);
...
btn_genhelp=uicontrol(subfig,...
    ...
    'String','?',...
    'Callback',[...
    'web(''interface/cufsmhelp.html#8'');']);
genbutclose=uicontrol(subfig,...
    ...
    'loading_cb(101);']);
%scale max and min
infotitle=uicontrol(subfig,...
    'Style','text','units','normalized',...
    'HorizontalAlignment','Left',...
    'Position',[0.02 0.01 0.16 0.03],...
    'String','Centerline (nodal) stresses:');
...
M11ytitle=uicontrol(subfig,...
    'Style','pushbutton','units','normalized',...
    'HorizontalAlignment','Right',...
    'Position',[0.25+0.01 0.84 0.049 0.03],...
    'String','M11y = ',...
    'Callback',[...
    'loading_cb(14);']);
M11yedit=uicontrol(subfig,...
    'Style','text','units','normalized',...
    'Position',[0.25+0.06 0.84 0.06 0.03],...
    'String',num2str(M11y),...
    'Callback',[...
    'loading_cb(1);']);
M22ytitle=uicontrol(subfig,...
    'Style','pushbutton','units','normalized',...
    'HorizontalAlignment','Right',...
    'Position',[0.25+0.01 0.80 0.049 .03],...
    'String','M22y = ',...
    'Callback',[...
    'loading_cb(15);']);
M22yedit=uicontrol(subfig,...
    'Style','text','units','normalized',...
    'Position',[0.25+0.06 0.80 0.06 0.03],...
    'String',num2str(M22y),...
    'Callback',[...
    'loading_cb(1);']);
%Geometric
...
Mxxytitle=uicontrol(subfig,...
    'Style','pushbutton','units','normalized',...
    'HorizontalAlignment','Right',...
    'Position',[0.25+0.126 0.84 0.049 0.03],...
    'String','Mxxy = ',...
    'Callback',[...
    'loading_cb(16);']);
Mxxyedit=uicontrol(subfig,...
    'Style','text','units','normalized',...
    'Position',[0.25+0.176 0.84 0.06 0.03],...
    'String',num2str(Mxxy),...
    'Callback',[...
    'loading_cb(1);']);
Mzzytitle=uicontrol(subfig,...
    'Style','pushbutton','units','normalized',...
    'HorizontalAlignment','Right',...
    'Position',[0.25+0.126 0.80 0.049 0.03],...
    'String','Mzzy = ',...
        'Callback',[...
    'loading_cb(17);']);
Mzzyedit=uicontrol(subfig,...
    'Style','text','units','normalized',...
    'Position',[0.25+0.176 0.80 0.06 0.03],...
    'String',num2str(Mzzy),...
    'Callback',[...
    'loading_cb(1);']);
label=uicontrol(subfig,...
