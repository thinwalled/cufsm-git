...
Fy=50;
b=4;
length_index_plotted=[13 25 40]
label=['Angle with lips (AISI 2002 Ex. I-11)'];
%
%Figures
figure(1)
...
axis([1 1000 0 0.65])
hold on,plot([b b],[0.5 0.6],'k:'),hold off
...
springs=0;
%local
axesshape=axes('Units','normalized','Position',[0.14 0.43 0.2 0.2],'visible','off');
scale=1;
