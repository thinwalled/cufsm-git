...
%
%minimum inputs
load Cnolip_modified_P
Fy=33;
b=5.698;
length_index_plotted=[13 20 30]
...
axis([1 1000 0 0.8])
hold on,plot([b b],[0.4 0.5],'k:'),hold off
...
axesnum=axes('Units','normalized','Position',[0.58 0.6 0.25 0.25],'visible','off');
