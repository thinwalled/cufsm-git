...
Fy=33;
b=2;
length_index_plotted=[20 25 32]
label=['Angle (AISI 2002 Ex. I-12)'];
%
%Figures
figure(1)
semilogx(curve(:,1),curve(:,2,2),'k:'), hold on
semilogx(curve(:,1),curve(:,2),'k.-')
axis([1 1000 0 0.9])
hold on,plot([b b],[0.8 1.0],'k:'),hold off
