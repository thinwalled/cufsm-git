...
axis([1 1000 0 5.0])
hold on,plot([b b],[3.5 4],'k:'),hold off
...
axesnum=axes('Units','normalized','Position',[0.4 0.6 0.25 0.25],'visible','off');
...
title(label)
text(b/2,1,['M_y=',num2str(Mxx_y,'%4.2f'),'kip-in.']);
%
...
springs=0;
%local
axesshape=axes('Units','normalized','Position',[0.18 0.33 0.25 0.25],'visible','off');
scale=1;
...
%LTB
axesshape=axes('Units','normalized','Position',[0.55 0.1 0.25 0.25],'visible','off');
scale=-1;
