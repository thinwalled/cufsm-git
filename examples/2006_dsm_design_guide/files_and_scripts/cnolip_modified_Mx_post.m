...
%
%minimum inputs
load cnolip_modified_mx
Fy=33;
b=5.698;
length_index_plotted=[14 20 30]
label=['C-section without lips modified '];
%
%Figures
figure(1)
semilogx(curve(:,1),curve(:,2),'k.-')
axis([1 1000 0 3])
hold on,plot([b b],[2 2.5],'k:'),hold off
...
springs=0;
%local
axesshape=axes('Units','normalized','Position',[0.22 0.23 0.25 0.25],'visible','off');
scale=1;
