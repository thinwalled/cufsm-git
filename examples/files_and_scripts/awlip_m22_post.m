...
axis([1 100 0 6.0])
hold on,plot([b b],[5 6],'k:'),hold off
...
title(label)
text(1,b/2,['M_y=',num2str(M22_y,'%4.2f'),'kip-in.']);
%
...
dispshap(undefv,node,elem,shapes(:,lengthindex,modeindex),axesshape,scale,springs);
title(['Torsional M_{cr}/M_y=',num2str(curve(lengthindex,2),'%2.2f')])
%title(['Distortional'])
%LTB
