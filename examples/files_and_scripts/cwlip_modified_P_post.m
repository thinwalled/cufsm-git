...
%
%minimum inputs
load Cwlip_modified_P
Fy=55;
b=9;
length_index_plotted=[35 50 76]
...
axesnum=axes('Units','normalized','Position',[0.25 0.6 0.25 0.25],'visible','off');
...
title(label)
%text(2,b/2,['P_y=',num2str(Py,'%4.2f'),'kips']);
%
...
%distortional
axesshape=axes('Units','normalized','Position',[0.42 0.13 0.25 0.25],'visible','off');
scale=1;
